...
const SideBySideList = ({ elementALabel, elementBLabel, sortedElementList, elementAColourListMap, elementBColourListMap, elementAImages, elementBImages }: Props) => {
            ...
            sortedElementList.map((entry, index) => {
                return (
                    <div style={colourMappingCHildStyle} key={index}>
                        <ColourWithImage
                            count={index}
                            backgroundColour={elementAColourListMap.get(entry.elementA) ?? "white"}
                            label={elementALabel}
                        ...
                        <ColourWithImage
                            count={index}
                            backgroundColour={elementBColourListMap.get(entry.elementB) ?? "white"}
                            label={elementBLabel}
